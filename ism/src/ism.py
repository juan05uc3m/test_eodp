...
class ism(initIsm):
    ...
    def processModule(self):
        ...
        for band in self.globalConfig.bands:
            ...
            #Se comentan lineas ya que hay partes que no estan implementadas
            # Detection Stage
            #una vez añadidos los metodos de detectionPhase y videoChainPhase volvemos
            #a quitar el # para que funcionen ambos módulos
            # -------------------------------------------------------------------------------
